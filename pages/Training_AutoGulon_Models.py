...
def main():
    ...
    if data_options == "Upload a dataset" and main_uploaded_file:
        ...
        #df_train = df_train.replace([np.inf, -np.inf], np.nan) # data cleaning
        ...
        #data_sets["Training Set"]["Data"] = df_train.to_dict(orient="records")
    ...
    # Add feedback to the user once they've uploaded their completed file.
        ...
        #data_sets["Index Set"]["Data"] = index_set.to_dict(orient="records")
