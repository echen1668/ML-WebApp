...
from Multi_Outcome_Classification_tools import multi_outcome_hyperparameter_binary, multi_outcome_hyperparameter_binary_train_and_test
...
def run_all_experiments(all_experiments, project_folder, data_sets, unique_value_threshold=10):
    ...
    for experiment in all_experiments[project_name]:
        ...
        algo_dictonary = multi_outcome_hyperparameter_binary_train_and_test(df_refined, input_cols, label_cols, numeric_cols, categorical_cols, options, algorithm, param_vals, experiment_name, project_folder, project_name)
